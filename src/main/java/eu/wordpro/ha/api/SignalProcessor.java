...
public interface SignalProcessor
{
     ...
     * @param inputs list of signals, where first element is a raw input to home automation framework. Next elements are outputs of processors in a processing chain. Most probably element used in the processor is the last one but it depends on implementation and configuration of the processor.
     ...
     */
    SignalProcessorData processInput(ProcessingData inputs) throws InvalidSignalException, SignalProcessingException;
